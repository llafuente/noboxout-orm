...
Most of ORM dot not handle errors, they will send you raw database/cache errors.

Norm will help you in the error handling so you can throw exception that are meaningful in your app. Here is an example.
