        ...
        storeOneToOne: function (entity, obj, callback, retried) {
            ...
            if (entity[this.property] !== null) {
                ...
                if (obj[this.foreignKey] == null) {
                    norm.verbose("*OneToOne store assign -> " + entity[this.property][this.refColumn]);
        ...
        storeOneToMany: function (entity, obj, callback, __retried) {
            ...
            if (max !== 0) {
                for (i = 0; i < max; ++i) {
                    ...
                    console.log(this.foreignKey, subentity[this.foreignKey], this.refColumn, entity[this.refColumn]);

                    changes = subentity.$changes();
                    if (!object.empty(changes)) {
                        subentity.$store(function() {
