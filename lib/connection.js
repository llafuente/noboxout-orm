(function () {
    ...
    var object = require("object-enhancements"),
        ...
        Connection,
        Util,
        mysql_errors = require("./mysql_errors.js");
        ...
        query: function (sql, args, callback) {
            ...
            this.database.query(sql, args, function (err, result) {
                if (err) {
                    ...
                    var err_regexp = mysql_errors[err.code] || mysql_errors[err.code + " " + err.sqlState],
                        ov_message;

                    if (err_regexp) {
                        err.tokens = err_regexp.exec(err.message).slice(1).map(function(v) {
