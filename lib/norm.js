(function () {
    ...
    Norm = __class("norm/norm", {
        ...
        "static verbose": function(input) {
            util.print(new Date().toISOString().slice(0, 19).replace('T', ' '), "[vrb]", __callee, input.cyanBG, "\n");
        },
        "static debug": function(input) {
            util.print(new Date().toISOString().slice(0, 19).replace('T', ' '), "[dbg]", __callee, input.blackBG, "\n");
        },
        "static warning": function(input) {
            util.debug(new Date().toISOString().slice(0, 19).replace('T', ' '), "[wrn]", __callee, input.yellowBG, "\n");
        },
        "static error": function(input) {
            util.debug(new Date().toISOString().slice(0, 19).replace('T', ' '), "[err]", __callee, input.redBG, "\n");
        }
