(function () {
    ...
    function store_entity_cb(con, entity, obj, callback) {
        ...
        if (table_data.timestamps) {
            ...
            if (entity[table_data.primaryKey] && obj[table_data.prefix + table_data.updatedAt] == null) {
    ...
    module.exports = {
        ...
        getEntity: function (Entity, pkval, con, fetch_options, callback) {
            Entity.$get(pkval).exec(con, function(err, ent) {
                if (err) {
                    return callback && callback(err, ent);
                }
                ...
                ent.$fetch(fetch_options, function() {
                    return callback && callback(null, ent);
                })
            });
        },
