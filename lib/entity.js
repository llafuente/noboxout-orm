(function () {
    ...
    __class("Norm/Entity", {
        ...
        "static $exists": function(pkval, con, callback) {
            ...
            query.query(con, function(err, result) {
        ...
        "static $exportRelation": function (mixed, rel, group) {
            ...
            if (Array.isArray(mixed)) {
                ...
                return mixed.$export(group, false);
            }
        ...
        $fetch: function (relations, callback) {
            ...
            (this.$self.$table.relations).forEach(function (rel) {
                if (!rel.isRoot(self) && rel.isBidirectional()) {
                ...
                case Relation.MANY_TO_ONE:
                    ...
                    if (rel.isRoot(self) && rel.hasForeignKey(self)) {
                        ...
                        if (rel.refColumn === rel.reference.$table.primaryKey) {
                            ...
                            return rel.reference.$get(self.$db[rel.foreignKey], {eager: false}).queryOne(self.connection, function (err, entity) {
                        ...
                        return rel.reference.$find(find).queryOne(self.connection, function (err, entity) {
                            self[rel.property] = entity;
                    ...
                    return rel.root.$find(find, callback).queryOne(self.connection, function (err, entity) {
